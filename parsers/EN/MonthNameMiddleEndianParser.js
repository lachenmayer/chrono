...
(function() {
  ...
  function MonthNameMiddleEndianParser(text, ref, opt) {
    ...
    parser.extract = function(text, index) {
      ...
      if (matchedTokens[4]) {
        ...
        var endDay = parseInt(matchedTokens[8], 10);
        var startDay = parseInt(matchedTokens[5], 10);
  ...
  exports.MonthNameMiddleEndianParser = MonthNameMiddleEndianParser;
})();
